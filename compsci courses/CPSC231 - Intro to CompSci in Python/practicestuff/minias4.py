...
# @arg(world: a reference to a 2D list of Strings of length one)
# @return(string,int):
#   @first return value = single string character entered by the user, string entered
#   @second return value = the number of times that the string was found in the list, number
def count(world):
